 ...
 */
class Vehiculo extends \AQ\CompraVentaBundle\Entity\Vehiculo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AQ\\CompraVentaBundle\\Entity\\Vehiculo' . "\0" . 'id', '' . "\0" . 'AQ\\CompraVentaBundle\\Entity\\Vehiculo' . "\0" . 'modelo', '' . "\0" . 'AQ\\CompraVentaBundle\\Entity\\Vehiculo' . "\0" . 'marca', '' . "\0" . 'AQ\\CompraVentaBundle\\Entity\\Vehiculo' . "\0" . 'valor');
        }
